    ...
    <div class="col-md-6">
      <form action="/posts">
        ...
        <div class="input-group mb-3">
          ...
          <button class="btn btn-outline-{{ $theme }}" type="submit">Search</button>
        </div>
      </form>
    </div>
  </div>
  ...
  @if ($posts->count())
    <div class="card mb-3">
      ...
      <div class="card-body text-center">
        ...
        <p class="card-text">{!! strlen($posts[0]->body) > 100 ? substr($posts[0]->body, 0, 250) . '...' : $posts[0]->body !!}</p>
          ...
          <div class="col-md-4 mb-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">{!! strlen($post->body) > 50 ? substr($post->body, 0, 50) . '...' : $post->body !!}</p>
